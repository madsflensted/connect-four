...
Elm.Center.make = function (_elm) {
   ...
   if (_elm.Center.values)
   return _elm.Center.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var markdown = F2(function (width,
   string) {
      return A2($Html.div,
...
Elm.Main.make = function (_elm) {
   ...
   model) {
      return function () {
         ...
         "",
         $Array.get(model.index)($Array.fromList(model.slides)));
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A2($Html.div,
                      ...
                      ,A2($Html.div,
                      _L.fromArray([]),
                      _L.fromArray([A2($Center.markdown,
                      "600px",
                      currentSlide)]))]));
      }();
   });
...
Elm.Slides.make = function (_elm) {
   ...
   if (_elm.Slides.values)
   return _elm.Slides.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
